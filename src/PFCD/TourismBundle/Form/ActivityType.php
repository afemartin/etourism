...
class ActivityType extends AbstractType
{
    public function buildForm(FormBuilder $builder, array $options)
    {
        ...
        if ($options['type'] == Constants::FORM_CREATE || $options['status'] == Activity::STATUS_PENDING)
        {
            ...
            $builder->add('duration', 'time', array('hours' => range(0, 23), 'minutes' => range(0, 60-$step, $step), 'empty_value' => array('hour' => 'Hour', 'minute' => 'Minute' ), 'attr' => array('class' => 'time-choice-compact'), 'help' => 'form.activity.field.duration.help'));
        }
    ...
    {
        return array('domain' => Constants::BACK, 'type' => Constants::FORM_CREATE, 'status' => Activity::STATUS_ENABLED, 'language' => 'en', 'supported_languages' => array(), 'supported_currencies' => array());
    }
